...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            .numeSiPrenume(DEFAULT_NUME_SI_PRENUME)
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client()
            .numeSiPrenume(UPDATED_NUME_SI_PRENUME)
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getNumeSiPrenume()).isEqualTo(DEFAULT_NUME_SI_PRENUME);
    ...
    void putNewClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getNumeSiPrenume()).isEqualTo(UPDATED_NUME_SI_PRENUME);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.adresa(UPDATED_ADRESA).telefon(UPDATED_TELEFON).email(UPDATED_EMAIL);
